...
//Ladda in bootstrap
  wp_enqueue_script( 'bootstrap4jsscript', 'https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-alpha.6/js/bootstrap.min.js', array ('jquery', 'tether'), true);
